...
export default function Header() {
  ...
  const slides = [
    ...
    },
    {
      ...
      subtitle:
        "Create stunning visuals with advanced artificial intelligence. Turn imagination into reality with our powerful tools.",
    ...
    },
    {
      ...
      subtitle:
        "Revolutionary video creation powered by AI. Bring your stories to life with cutting-edge technology.",
    ...
    //   subtitle:
    //     "Your complete creative workspace. Design, edit, and produce content with intelligent AI-powered tools.",
    //   background: require("../assets/images/4.png"), // Add more backgrounds to your assets
    // },
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Animated.View
          style={[styles.slideshowContainer, { transform: [{ translateX }] }]}
        >
          <ImageBackground
